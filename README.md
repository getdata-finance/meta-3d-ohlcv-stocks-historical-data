...
**META 3d OHLCV stocks historical data** — ultra high-quality 3d OHLCV for **Meta Platforms**. Clean `time, open, high, low, close, volume` CSV for backtesting, algorithmic trading and quantitative research.
...
> **Sample on GitHub** · `META_3d.csv` (68 rows, `2026-02-09` -> `2026-09-01`, 4.09 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/meta)** — **1,576** `3d` rows (full `1m`: 637,227), **11 timeframes**, `2012-05-17` -> `2026-09-01`.
...
| 3d rows | 68 | **1,576** |
| Size | 4.09 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/meta) |
...
df = pd.read_csv('META_3d.csv', parse_dates=['time'])
